 ...
 * given two versions "1.1.0" and "1.2.0", each would be on the same net.orpiske.ucf.contrib.version.slot. On
 * the other hand, "1.0.0" and "2.0.0" are on a separate net.orpiske.ucf.contrib.version.slot.
 * 
